...
def main(argv):
    ...
    # /Users/diegoibarra/Developer/1_myProjects/Apps/ToDo/resources/images
...
def todoListNotEmpty(table_image_path: str, stock_wallpaper: str, savepath: str) -> None:
    ...
    # / IF THE CODE WORKS, THE FOLLOWING CODE CAN BE DELETED
    # height_difference = round((new_height - table_height))
    # table_y = round(height_difference * top_shift_ratio)
