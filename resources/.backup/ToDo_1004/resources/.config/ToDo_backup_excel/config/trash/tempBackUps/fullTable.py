...
def styleTable(df):
    ...
    propsHead = 'font-family: SF Pro Display; color: #FFFFFF; font-size:1.2em; border: 1px solid black'
...
df = getTableDF()
tableDone = df.style.set_table_styles(styleTable(df)).hide()
dfi.export(tableDone, 'meowmeow.png', dpi=300)
